        ...
        <div className={styles.sidebarContainer}>
            ...
            <div className={styles.allNavItem}>
                ...
                <div className={`${styles.dropdownMenu} ${isDropdownOpen ? styles.open : ''}`}>
                    ...
                    <Link to="/admin-events/adminform">
                        <div
                            className={`${styles.dropdownItem} ${
                                activeDropdownItem === "/admin-events/adminform"
                                    ? styles.pageactive
                                    : ""
                            }`}
                            onClick={() => handleDropdownItemClick("/admin-events/adminform")}
                        >
                            <h1 className={styles.dashboardtext}>Admin Form</h1>
                        </div>
                    </Link>
