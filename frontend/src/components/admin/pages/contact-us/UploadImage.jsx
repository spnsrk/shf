...
import './UploadImage.css'; // Assuming you have some basic CSS for styling
...
const UploadImage = () => {
    ...
    const uploadToServer = (file) => {
        ...
        axios.post(`${API_URL}/contactusimage`, formData)
            .then(response => {
    ...
    return (
        <>
            ...
            <h1 className='contact-us-information-text'>Contact  Information</h1>
