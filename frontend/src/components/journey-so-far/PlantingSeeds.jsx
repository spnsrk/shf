...
const PlantingSeeds = () => {
    return (
        <>
            <div className="xl:mx-52 mx-4 sm:m-8 flex flex-col-reverse md:flex-row gap-6 md:gap-8">
                <div className="text-container md:w-3/5">
                    <div className="mb-6">
                        <div className="flex items-center">
                            <p className="font-montserrat text-base font-semibold text-[rgba(37,42,52,1)]" style={{ marginBottom: '15px' }}>Through The Decades</p>
                    ...
                    <div
                        className="planting-seeds-section font-nunito text-xs lg:text-sm xl:text-sm font-normal"
                        style={{ color: "rgba(37, 42, 52, 0.50)", fontFamily: "'Nunito Sans'", fontSize: '16px', fontWeight: 400, lineHeight: '30px' }}
                    >
                        <p>
                            The period between the 1920's and 1990's witnessed a significant development in the presence of Hindus in
                ...
                <img
                    className="rounded-lg overflow-hidden w-full md:w-2/5"
                    src="/Images/journey-so-far/Group 1171275378.png"
                    alt=""
                />
            </div>
            ...
            <div className="xl:mx-52 m-8  md:flex md:justify-center xl:-translate-y-36">
                <div className="mb-10 md:mb-0 md:mr-10">
                    <h1
                        className="font-montserrat text-1xl font-bold text-center mb-2 md:text-start md:ml-2"
                        style={{
                            color: '#252A34',
                    ...
                    >Glasgow</h1>
                    <p
                        className="md:w-80 text-xs md:text-sm font-nunito font-normal bg-[rgba(254,242,228,0.41)] text-[rgba(38,50,56,1)] p-5"
                        style={{
                            color: '#263238',
                ...
                <div>
                    ...
                    >Lesmahagow</h1>
                    <p
                        className="md:w-96 text-xs md:text-sm font-nunito font-normal bg-[rgba(254,242,228,0.41)] text-[rgba(38,50,56,1)] p-5"
                        style={{
                            color: '#263238',
                            fontFamily: 'Nunito Sans',
                            fontSize: '16px',
