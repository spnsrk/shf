            ...
            <div className="xl:mx-52 m-8">
                ...
                <div className="my-8">
                    <div className="flex items-center">
                        <p className="font-montserrat text-base font-semibold text-[rgba(37,42,52,1)]" style={{marginBottom: '15px'}}>The Journey</p>
                ...
                <div className="mb-5 mt-16 flex  justify-center">
                    <div className="md:ml-16">
                        <h1
                            className="text-center font-montserrat text-xl"
                            style={{
                                color: '#F4911F',
                                textAlign: 'center',
                        ...
                        <p
                            className="text-center max-w-md font-nunito text-sm mt-3"
                            style={{
                ...
                <div className="flex flex-col mt-20 w-full">
                    ...
                    <div className="md:flex md:self-start justify-center mb-20 md:mb-0">
                        ...
                        <div className="self-center  justify-center md:ml-10 ml-5">
                            ...
                            >Colonel John Baillie, a British soldier, was stationed in India during the same period. He had a keen interest in Indian history, culture, and religion. Baillie’s interactions with Hindus and his travels throughout The Indian subcontinent sparked a fascination with Hinduism.</p>
                        </div>
                    </div>
                    ...
                    <div className="md:flex md:self-end justify-center">
                        ...
                        <div className="self-center md:order-1 md:mr-10 ml-5 md:ml-0">
                            ...
                            >Neil Benjamin Edmonstone, a Scottish surgeon, ventured to India in the early 19th century. He served in the Bengal Medical Service and worked extensively in Bengal and Assam.</p>
                        </div>
                    </div>
