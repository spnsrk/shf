...
const Form1 = () => {
    ...
    const handleContactus = async (e) => {
        ...
        try {
            const result = await axios.post(`${API_URL}/contactusform`, { name, email, location, phone, message });
    ...
    return (
        <div className="">
            ...
            <div className="m-6 justify-items-center md:flex md:justify-center">
                ...
                <div className="md:w-[60%]  xl:w-[50%] htmlForm-container ml-2 md:ml-5 mt-2" style={{marginLeft: '45px'}}>
                    <p
                        style={{
                            color: "#2F2211",
