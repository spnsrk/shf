...
const Donatecard = () => {
  return (
    <div className="relative z-20 h-[60vh] sm:h-[80vh] md:h-svh w-full">
      <div className="relative z-20 h-full w-full">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center text-white text-center z-30">
          <div>
            <p
              className="text-bold font-montserrat"
              style={{
                color: "#FFF",
                textAlign: "center",
            ...
            <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold mt-4 font-playfair">
              A Tale Of Scottish
              <br />Hindus In Scotland

            </h1>
            <p
              className="text-sm font-[400px] mt-4 font-inter"
              style={{
            ...
            <div className="flex flex-wrap mt-8 justify-center gap-3">
              <Link to="/donate">
                <button className="bg-shfOrange font-light font-inter hover:bg-shfPurple transition duration-300 text-white py-2 px-6 border-2 border-shfOrange rounded-full text-sm sm:text-base">
                  Donate
                </button>
              </Link>

              <Link to="/report-an-issue">
                <button className="bg-transparent hover:bg-red-600 font-inter transition duration-300 text-white py-2 px-6 border-2 border-white rounded-full text-sm sm:text-base">
                  Report an Issue
                </button>
              </Link>
            </div>
