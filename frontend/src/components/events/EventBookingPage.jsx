...
const EventBookingPage = () => {
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${API_URL}/events/${eventId}/booking`, bookingDetails)
            .then(() => {
                navigate(`/event/${eventId}/booking-success`);
            })
            .catch((error) => {
    ...
    return (
        <div className="relative">
            <Header />
            <Herosection
                imageUrl={event.heroImageUrl || '/Images/Herosection/events.png'}
